...
public class ArithmeticSpiral extends ALine implements Line {
    ...
    /* package */ static List<Delta> getDeltas( final double _maxPointDistance, final Point _end, final Point _center, final double _centerTheta, final int _turns ) {
        ...
        double sRho = from.rho;     // the distance from the center to the start point...
        double eRho = to.rho;       // the distance from the center to the end point...
        ...
        double eTheta = toIsCenter   ? _centerTheta : center.thetaTo( to   );   // the angle from the center to the end...
        double sTheta = fromIsCenter ? _centerTheta : center.thetaTo( from );   // the angle from the center to the start...
